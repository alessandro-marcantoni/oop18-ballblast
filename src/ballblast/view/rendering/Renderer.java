...
/**
 * Represent an object that know how to draw itself on the canvas. Layer numbers
 * are used to decide the order in which renderers will be drawn on the screen.
