...
/**
 * Maintains the count of all game data associated with a {@link Level}.
 */
public class GameDataManager {
    private final GameData gameData;
    /**
     * Creates a {@link GameDataManager} instance.
     */
     ...
     * @param score
     *     the score calculated during the current update.
     */
    ...
    /**
     * Contains all the game data, these can only be modified using the {@link GameDataManager} class, 
     * but the getters are public so the values are accessible to anyone.
     */
