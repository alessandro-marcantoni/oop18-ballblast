 ...
 /**
  ...
  public GravityComponent() { super(ComponentTypes.GRAVITY); this.gravity =
  STANDARD_GRAVITY; }
 ...
 /**
  ...
  super(ComponentTypes.GRAVITY); this.gravity = gravity; }
  
  @Override public final void update(final double elapsed) { final Vector2D dV
  = gravity.multiply(elapsed);
 ...
 /**
    ...
    */
        public void setGravity(final Vector2D gravity) { this.gravity = gravity; }
